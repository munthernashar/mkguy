...
-- Defensive migration for environments where profiles was not created yet.
...
-- Keep policies deterministic/idempotent.
...
-- Optional signup bootstrap trigger (enabled here to keep admin display names stable).
